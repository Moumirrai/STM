    ...
    def solve(self) -> np.ndarray:
        ...
        for node in self.truss.nodes:
            ...
            if node.constrained_x:
                fixedConstraints.append(FixedConstraint(dof=base_dof))

            if node.constrained_y:
                fixedConstraints.append(FixedConstraint(dof=base_dof + 1))
        ...
        print(fixedConstraints)

        print(dependentConstraints)
